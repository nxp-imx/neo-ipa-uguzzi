...
Release android-17.0.0_1.0.0 (September 2026)
=============================================

Associated versions
-------------------

* IPA release: android-17.0.0_1.0.0
* IPA version: UGUZZI_IPA_v0.2.7
* libcamera release: android-17.0.0_1.0.0
...
* Support for the ox03c10 and os08a20 sensors
...
* Use configuration file 'config_ipa_uguzzi.yaml' with sensors configuration defined by user
